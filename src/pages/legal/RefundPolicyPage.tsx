...
const sections = [
  ...
  { title: '3. Processing Times', content: 'Approved refunds are credited to your RefundPay wallet immediately. Withdrawals to external accounts take: Bank Transfer (1-5 business days), PayPal (1-2 business days), Mobile Money (instant to 24 hours), Crypto (10-60 minutes).' },
